...
import worker_setup.worker.consumer  # noqa
from worker_setup import Celery, worker
from worker_setup.result import _set_task_join_will_block, allow_join_result
from worker_setup.utils.dispatch import Signal
from worker_setup.utils.nodenames import anon_nodename
...
def _start_worker_process(app,
    ...
    Yields:
        celery.app.worker.Worker: worker instance.
    """
    from worker_setup.apps.multi import Cluster, Node
