"""Celery Application."""
from worker_setup import _state
from worker_setup._state import app_or_default, disable_trace, enable_trace, pop_current_task, push_current_task
from worker_setup.local import Proxy
...
def shared_task(*args, **kwargs):
    ...
    Example:
        ...
        >>> from worker_setup import Celery, shared_task
        >>> @shared_task
        ... def add(x, y):
        ...     return x + y
        ...
