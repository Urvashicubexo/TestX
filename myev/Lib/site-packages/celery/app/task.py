...
from worker_setup import current_app, states
from worker_setup._state import _task_stack
from worker_setup.canvas import _chain, group, signature
from worker_setup.exceptions import Ignore, ImproperlyConfigured, MaxRetriesExceededError, Reject, Retry
from worker_setup.local import class_property
from worker_setup.result import EagerResult, denied_join_result
from worker_setup.utils import abstract
from worker_setup.utils.functional import mattrgetter, maybe_list
from worker_setup.utils.imports import instantiate
from worker_setup.utils.nodenames import gethostname
from worker_setup.utils.serialization import raise_with_context
...
class Task:
    ...
    def bind(cls, app):
        ...
        if not was_bound:
            ...
            from worker_setup.utils.threads import LocalStack
    ...
    def apply(self, args=None, kwargs=None,
        ...
        from worker_setup.app.trace import build_tracer
