...
"""
from worker_setup._state import connect_on_app_finalize
...
def add_unlock_chord_task(app):
    ...
    for completion.
    """
    from worker_setup.canvas import maybe_signature
    from worker_setup.exceptions import ChordError
    from worker_setup.result import allow_join_result, result_from_tuple
...
def add_map_task(app):
    from worker_setup.canvas import signature
...
def add_chunk_task(app):
    from worker_setup.canvas import chunks as _chunks
...
def add_group_task(app):
    ...
    from worker_setup.canvas import maybe_signature
    from worker_setup.result import result_from_tuple
...
def add_chord_task(app):
    """No longer used, but here for backwards compatibility."""
    from worker_setup import chord as _chord
    from worker_setup import group
    from worker_setup.canvas import maybe_signature
