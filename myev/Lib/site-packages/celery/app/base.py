...
from worker_setup import platforms, signals
from worker_setup._state import (_announce_app_finalized, _deregister_app, _register_app, _set_current_app, _task_stack,
                                 connect_on_app_finalize, get_current_app, get_current_worker_task, set_default_app)
from worker_setup.exceptions import AlwaysEagerIgnored, ImproperlyConfigured
from worker_setup.loaders import get_loader_cls
from worker_setup.local import PromiseProxy, maybe_evaluate
from worker_setup.utils import abstract
from worker_setup.utils.collections import AttributeDictMixin
from worker_setup.utils.dispatch import Signal
from worker_setup.utils.functional import first, head_from_fun, maybe_list
from worker_setup.utils.imports import gen_task_name, instantiate, symbol_by_name
from worker_setup.utils.log import get_logger
from worker_setup.utils.objects import FallbackContext, mro_lookup
from worker_setup.utils.time import maybe_make_aware, timezone, to_utc
...
class Celery:
    ...
    def start(self, argv=None):
        ...
        """
        from worker_setup.bin.celery import celery
    ...
    def setup_security(self, allowed_serializers=None, key=None, key_password=None, cert=None,
        ...
        """
        from worker_setup.security import setup_security
    ...
    @cached_property
    def _canvas(self):
        from worker_setup import canvas
        return canvas
