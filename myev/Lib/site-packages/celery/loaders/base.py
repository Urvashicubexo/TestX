...
from worker_setup.exceptions import reraise
from worker_setup.utils.collections import DictAttribute, force_mapping
from worker_setup.utils.functional import maybe_list
from worker_setup.utils.imports import NotAPackage, find_module, import_from_cwd, symbol_by_name
...
class BaseLoader:
    ...
    def cmdline_config_parser(self, args, namespace='celery',
        ...
        from worker_setup.app.defaults import NAMESPACES, Option
