...
from worker_setup.bin.base import LOG_LEVEL, CeleryDaemonCommand, CeleryOption, handle_preload_options
from worker_setup.platforms import detached, set_process_title, strargv
...
def _run_evdump(app):
    from worker_setup.events.dumper import evdump
...
def _run_evcam(camera, app, logfile=None, pidfile=None, uid=None,
               ...
               detach=False, **kwargs):
    from worker_setup.events.snapshot import evcam
...
def _run_evtop(app):
    try:
        from worker_setup.events.cursesmon import evtop
