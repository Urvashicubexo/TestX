...
from worker_setup import concurrency
from worker_setup.bin.base import (COMMA_SEPARATED_LIST, LOG_LEVEL, CeleryDaemonCommand, CeleryOption,
                                   handle_preload_options)
from worker_setup.concurrency.base import BasePool
from worker_setup.exceptions import SecurityError
from worker_setup.platforms import EX_FAILURE, EX_OK, detached, maybe_drop_privileges
from worker_setup.utils.log import get_logger
from worker_setup.utils.nodenames import default_nodename, host_format, node_format
...
def detach(path, argv, logfile=None, pidfile=None, uid=None,
    ...
    with detached(logfile, pidfile, uid, gid, umask, workdir, fake,
        ...
        try:
            ...
            if app is None:
                from worker_setup import current_app
                app = current_app
