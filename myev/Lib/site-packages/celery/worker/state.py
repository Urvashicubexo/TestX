...
from worker_setup import __version__
from worker_setup.exceptions import WorkerShutdown, WorkerTerminate
from worker_setup.utils.collections import LimitedSet
...
if C_BENCH:  # pragma: no cover
    ...
    from worker_setup.utils.debug import memdump, sample_mem
