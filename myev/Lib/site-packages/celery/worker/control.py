...
from worker_setup.exceptions import WorkerShutdown
from worker_setup.platforms import EX_OK
from worker_setup.platforms import signals as _signals
from worker_setup.utils.functional import maybe_list
from worker_setup.utils.log import get_logger
from worker_setup.utils.serialization import jsonify, strtobool
from worker_setup.utils.time import rate
...
def memsample(state, **kwargs):
    ...
    from worker_setup.utils.debug import sample_mem
    return sample_mem()
...
def memdump(state, samples=10, **kwargs):  # pragma: no cover
    ...
    from worker_setup.utils import debug
    out = io.StringIO()
