...
from worker_setup import VERSION_BANNER, platforms, signals
from worker_setup.app import trace
from worker_setup.loaders.app import AppLoader
from worker_setup.platforms import EX_FAILURE, EX_OK, check_privileges, isatty
from worker_setup.utils import static, term
from worker_setup.utils.debug import cry
from worker_setup.utils.imports import qualname
from worker_setup.utils.log import get_logger, in_sighandler, set_in_sighandler
from worker_setup.utils.text import pluralize
from worker_setup.worker import WorkController
...
def _shutdown_handler(worker: Worker, sig='SIGTERM', how='Warm', callback=None, exitcode=EX_OK, verbose=True):
    ...
    def _handle_request(*args):
        with in_sighandler():
            from worker_setup.worker import state
...
def on_hard_shutdown(worker: Worker):
    ...
    """
    from worker_setup.exceptions import WorkerTerminate
...
def install_rdb_handler(envvar='CELERY_RDBSIG',
    ...
    def rdb_handler(*args):
        ...
        with in_sighandler():
            from worker_setup.contrib.rdb import _frame, set_trace
