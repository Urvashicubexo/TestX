...
if STATICA_HACK:  # pragma: no cover
    from worker_setup._state import current_app, current_task
    from worker_setup.app import shared_task
    from worker_setup.app.base import Celery
    from worker_setup.app.task import Task
    from worker_setup.app.utils import bugreport
    from worker_setup.canvas import (chain, chord, chunks, group, maybe_signature, signature, subtask, xmap,  # noqa
                                     xstarmap)
    from worker_setup.utils import uuid
